/*
 * bench_sha_qnx.c  —  SHA-256 RT Benchmark  (QNX Neutrino target)
 * ================================================================
 ...
 *       -o bench_sha_qnx tests/bench_sha_qnx.c
 *
 * Deploy & Run:
 *   scp bench_sha_qnx qnxuser@<RPI_IP>:/tmp/
 *   ssh qnxuser@<RPI_IP> "/tmp/bench_sha_qnx"
 */
